...
export function ContextualTopBar({ onMenuClick }: ContextualTopBarProps) {
  ...
  return (
    <header className="relative z-50 h-[60px] flex items-center justify-between px-3 lg:px-6 border-b border-border/50 select-none bg-white/40 dark:bg-slate-900/40 backdrop-blur-md">
